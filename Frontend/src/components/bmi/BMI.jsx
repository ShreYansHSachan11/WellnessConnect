...
const BMI = () => {
  ...
  const fetchRecipes = async () => {
    try {
        const apiKey = 'Q804jbYVbjR0S2ZYe2jWPWdebTulkqh8';

      const response = await axios.get(`https://api.spoonacular.com/recipes/findByNutrients?minCalories=${bmr - 200}&maxCalories=${bmr + 200}&number=8&apiKey=${apiKey}`);
